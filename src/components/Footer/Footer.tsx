            ...
            <div className="socials-footer">
                ...
                <div className="social-btns-footer">
                    <Button
                        className="apex-insurance-logo-btn"
                        icons={[
                            { src: '/facebook.svg', alt: 'apex-insurance-logo', className: 'socials-btns-img' },
                        ]}
                    />
                    <Button
                        className="apex-insurance-logo-btn"
                        icons={[
                            { src: '/instagram.svg', alt: 'apex-insurance-logo', className: 'socials-btns-img' },
                        ]}
                    />
                    <Button
                        className="apex-insurance-logo-btn"
                        icons={[
                            { src: '/linkedin.svg', alt: 'apex-insurance-logo', className: 'socials-btns-img' },
                        ]}
                    />
                    <Button
                        className="apex-insurance-logo-btn"
                        icons={[
                            { src: '/gmail.svg', alt: 'apex-insurance-logo', className: 'socials-btns-img' },
                        ]}
                    />
                </div>
            </div>
